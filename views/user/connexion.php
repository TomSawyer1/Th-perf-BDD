  ...
  <div class="login-box">
    ...
    <form method="post" action="" id="connect">
      ...
      <div class="user-box">
        ...
        <input type="email" id="typeEmailX-2" onclick="effacerLabel('typeEmailX-2')" class="form-control form-control-lg" name="mail" value="<?= !empty($_SESSION['mail']) ? $_SESSION['mail'] : ""; ?>">
      </div>
      <div class="user-box">
        <label class="form-label" for="typePasswordX-2">MOT DE PASSE</label>
        <input type="password" id="typePasswordX-2" onclick="effacerLabel('typePasswordX-2')" class="form-control form-control-lg" name="password" />
      </div>
